		...
		else if(taskTitle.equals("update"))
		{
		    ...
		    try
		    {
			    ...
			    if(file_name.length()>2)
			    {
					...
					//update query
					updateRequest = new UpdateRequest(INDEX_NAME, DOC_TYPE, id_value).doc(jsonBuilder()
						        .startObject().field("topic_description", short_desc)
